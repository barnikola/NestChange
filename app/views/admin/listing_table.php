...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="7" style="text-align:center; padding: 30px;">No listings found.</td>
        </tr>
        <?php else: ?>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars(($listing['first_name'] ?? '') . ' ' . ($listing['last_name'] ?? '')) ?> <br> <small><?= htmlspecialchars($listing['host_email']) ?></small></td>
                <td>

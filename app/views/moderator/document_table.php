...
<head>
    <meta charset="UTF-8">
    <title>Moderator - Verify Documents</title>
...
<h1 style="text-align:center;">Moderator - Document Verification</h1>
        ...
        <?php else: ?>
            ...
            <tr>
                ...
                <td class="actions" style="display:flex; gap:5px;">
                    <a href="<?= $baseUrl . '/' . ($doc['document_path'] ?? '#') ?>" target="_blank" style="text-decoration:none;">

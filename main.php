...
<body<?php echo $bodyAttr; ?>>
            ...
            <div class="header-right">
                <?php if ($navContext['is_logged_in']): ?>
                    ...
                    <div class="notifications-dropdown">
                        <button id="notification-bell" class="notification-btn" title="Notifications">
                            <i data-lucide="bell"></i>
                            <?php if ($navContext['notification_count'] > 0): ?>
                                <span class="notification-count"><?= $navContext['notification_count'] ?></span>
                            <?php endif; ?>
                        </button>
                        <div id="notification-dropdown-menu" class="dropdown-menu notification-menu">
    ...
    <script>
        // Refresh icons after dynamic content loader if needed

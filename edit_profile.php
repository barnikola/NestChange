    ...
    <div class="edit-profile-card">
        ...
        <form class="edit-form" action="/profile/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="edit-photo-row">
                ...
                <input type="file" class="edit-input" name="profile_picture" accept="image/*" capture="user"
                    id="photoUpload">
            </div>
            ...
            <input type="file" class="edit-input" name="id_document" accept=".pdf,.jpg,.jpeg,.png,image/*">
